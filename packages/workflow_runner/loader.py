...
def _normalize_step(step_data: Any) -> Step | None:
...
def _load_definition_file(path: Path) -> SkillDefinition | ToolDefinition | None:
...
def resolve_skill_path(skill_name: str, search_paths: list[Path] | None = None) -> Path | None:
    """
...
def resolve_tool_path(tool_name: str, search_paths: list[Path] | None = None) -> Path | None:
    """
...
def resolve_workflow_path(workflow_name: str, search_paths: list[Path] | None = None) -> Path | None:
    """
